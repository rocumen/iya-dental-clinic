...
const OldProcedureDetails = () => {
  ...
  const handleCreateChart = () => {
    if (chartType === "adult") {
      navigate(`/dentalChartAdult/${patientId}`);
    } else if (chartType === "kid") {
      navigate(`/dentalChartKids/${patientId}`);
    }
          ...
          {patient?.dentalChartAdult || patient?.dentalChartKids ? (
            <>
              ...
              <div className="d-flex gap-3">
                <LinkContainer
                  to={`/dentalChartKids/${patientId}/update/${patient?.dentalChartKids?._id}`}
                >
                  <div>
                ...
                <LinkContainer
                  to={`/dentalChartAdult/${patientId}/update/${patient?.dentalChartAdult?._id}`}
                >
                  <div>
